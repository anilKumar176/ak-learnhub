  ...
  return (
    <div>
      ...
      <div className="max-w-maxContent relative mx-auto flex flex-col w-11/12 item-center text-white justify-between ">
        <Link to={"/signup"}>
          <div className="group mt-16 p-1 mx-auto rounded-full bg-gradient-to-r from-blue-400 via-purple-500 font-bold text-white transition-all duration-200 hover:scale-105 w-fit ">
